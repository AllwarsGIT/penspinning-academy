...
function TrickNameCard({ title="", thumbnail="", href="", badge="" }: TrickNameCardProps) {
    ...
    return (
        <Link href={href} className="w-full rounded-xl overflow-hidden cursor-pointer group hover:scale-105 transition-all duration-500 ease-in-out">
            <div className="w-full aspect-video">
                ...
                <div className="p-3 flex flex-col gap-2 bg-whitePrimary dark:bg-blackPrimary">
                    <h2 className="font-semibold group-hover:opacity-70">
                        {title}
                    </h2>
                    {badge && (
                        <span 
