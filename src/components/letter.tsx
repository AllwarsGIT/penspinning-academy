...
function Letter() {
    return (
        <section className="flex flex-col w-full px-8 py-20 bg-white dark:bg-black transition-colors duration-500 items-center justify-center">
            <div className="max-w-2xl w-full flex flex-col gap-8">

                <div className="flex flex-col gap-3 items-start">
                    
                    <h2 className="text-2xl font-bold font-inter">
                        To the penspinning community
                    </h2>
                </div>
